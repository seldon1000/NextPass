...
The app is far from dead, I personally use it and want to improve it further. My main focus is implementing encryption and then make NextPass an official Passowrds third party client, however I need some time to do everything. I'm finally graduating 🎉, so I will have little to no free time for a couple of months, then I'll be back.
